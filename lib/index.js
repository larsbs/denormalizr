...
function denormalizeObject(obj, entities, schema, bag) {
  ...
  Object.keys(schema).filter(function (attribute) {
    ...
    if (typeof (0, _ImmutableUtils.getIn)(obj, [attribute]) === 'undefined' && schema[attribute] instanceof _IterableSchema2.default) {
      denormalized = (0, _ImmutableUtils.setIn)(denormalized, [attribute], []);
    } else {
